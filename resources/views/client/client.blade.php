                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="owl-carousel articles-carousel">
                            ...
                            <div class="card">
                                <div class="photo">
                                    <img src="{{asset($post->find(2)->image)}}" class="card-img-top" alt="...">
                                    <a href="article-details.html" class="click">المزيد</a>
                                </div>
                                <a  class="favourite">
                                    <i url="{{route('togglePosts')}}" id="{{$post->id}}" onclick="togglePosts(this)" class="far fa-heart first-heart"></i>
                                </a>
