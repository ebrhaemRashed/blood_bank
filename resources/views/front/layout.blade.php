            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                <a href="{{$setting->first()->fb_link}}" class="facebook"><i class="fab fa-facebook-f"></i></a>
                                <a href="{{$setting->first()->inst_link}}" class="instagram"><i class="fab fa-instagram"></i></a>
                                <a href="{{$setting->first()->tw_link}}" class="twitter"><i class="fab fa-twitter"></i></a>
                                <a href="{{$setting->first()->fb_link}}" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <!--not a member-->
                        <div class="accounts">
                            <a href="{{route('create-account')}}" class="create">إنشاء حساب جديد</a>
                            <a href="{{route('signin-account')}}" class="signin">الدخول</a>
                            @if(Auth::check())
                            <form action="{{url(route('clientlogout'))}}" method="post">
                                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="pages col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action" id="list-settings-list" href="{{route('who-are-us')}}" role="tab" aria-controls="settings">من نحن</a>
